...
\begin{tikzpicture}[%
	...
	\node[my node, fill=white](2)[below of=1, xshift=1cm]{\color{emblue}Loop \\ \color{emblue}Summarization};
	\node[my node, fill=white](3)[below of=2]{\color{emblue} Loop \\ \color{emblue} Replacement};
