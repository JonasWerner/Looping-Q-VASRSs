...
\begin{tikzpicture}[%
	...
	\node[align=center](input) {\color<1-3>{emblue} \textbf{Input}: \\ \color<1-2>{emblue} Program $P$};
	\node[in node, fill=white](5)[below of=input, yshift=0.25cm]{\color<4->{emblue}Construct Control-Flow Graph $G$};
