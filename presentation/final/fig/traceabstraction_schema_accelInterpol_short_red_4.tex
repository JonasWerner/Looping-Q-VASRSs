...
\begin{tikzpicture}[%
	...
	\node[my node, fill=white](4)[below of=3]{\color<2-10>{emblue} Meta-Interpolant \\ \color<2-10>{emblue} Computation};
	\node[my node, fill=white](interpolants)[below of=4, xshift=-1cm]{\color<11->{emblue}Inductive Interpolant  Computation};
