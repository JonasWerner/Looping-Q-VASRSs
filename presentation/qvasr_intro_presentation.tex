...
\begin{frame}[t]
	\frametitle{\qvasr}
	\begin{itemize}
		\item A \qvasr\ $V$ is a transition system, consisting of a set of transformer: \\ \vspace*{0.5cm}
		\begin{center}
		 $ V = 
		\begin{Bmatrix}
			\begin{pmatrix}
	...
	\end{center}
	\vspace*{0.5cm}
	\item That model transitions between two states $\vec{x}$ and $\vec{x}'$ as \\
	\begin{equation*}
			\begin{bmatrix}
				x_1' \\
				\vdots \\
