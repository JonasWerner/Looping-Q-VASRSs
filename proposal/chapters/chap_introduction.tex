...
Silverman and Kincaid\cite{10.1007/978-3-030-25543-5_7} proposed a technique that computes loop summaries using rational vector addition systems (\qvasr)

\begin{minipage}[t]{0.3\linewidth} \centering
	\begin{figure}[H]
		\input{fig/lst_ex_p0.tex}
		\caption{Program $P$ \\ with while loop.}
	\end{figure}
\end{minipage}
