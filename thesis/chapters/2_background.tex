...
Trace abstraction considers a given program's $P$ control-flow graph as a nondeterministic finite automaton \cfgAutomat{P}, and uses it to iteratively compute a Floyd-Hoare automaton \cfgAutomatHoare{D} containing all infeasible paths following the paradigm shown in Figure \ref{traceAbstractionScheme}.
