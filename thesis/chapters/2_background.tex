...
In this thesis we utilize various concepts of linear algebra, such as vector spaces, vector space bases, and more. This section will introduce our notations and definitions.
...
\begin{center}
	...
	\end{minipage}
\end{center}
For the rest of the thesis, denote control-flow graph with error location just as control-flow graph unless stated otherwise.
