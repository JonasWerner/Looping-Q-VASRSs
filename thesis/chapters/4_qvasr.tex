...
\end{align*}
We get a vector space for which we need to compute a basis. Assume we have basis for the set of resets:
...
We use the updates to variables: $x' = x + y, \ y'= y + 1\ z' = x$ , found in $H$, to solve the following equations for $s_1, s_2, s_3$: \\
\begin{align*}
